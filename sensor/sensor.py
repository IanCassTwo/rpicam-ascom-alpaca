...
class Sensor(ABC):
    def __init__(self, name, size_x, size_y, max_binning, pixel_size, max_gain, min_exposure, max_exposure, electrons_per_adu, full_well_capacity, raw_format, bayer_pattern):
        self._name = name
        self._size_x = size_x
        self._size_y = size_y
